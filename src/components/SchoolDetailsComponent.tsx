...
const SchoolDetailsComponent: React.FC = () => {
  ...
  if (isError)
    return <div>Failed to fetch school details. Please try again later.</div>;
  ...
  return (
    <div className="school-details-container">
      ...
      <div className="school-info">
        ...
        <p>
          <strong>Status:</strong> {school.school_status}
        </p>
        <p>
        ...
        <p>
          <strong>Sector:</strong> {school.sector_name}
        </p>
        <p>
          <strong>Cell:</strong> {school.cell_name}
        </p>
        <div className="combinations">
          ...
          {school.combination_ids.map((combination: ICombination) => (
            <div className="combination" key={combination._id}>
              <p>
                <strong>Name:</strong> {combination.name}
              </p>
              <p>
                <strong>Abbreviation:</strong> {combination.abbreviation}
              </p>
              <p>
                <strong>Description:</strong> {combination.description}
              </p>
            </div>
          ))}
        </div>
